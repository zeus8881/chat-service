...
public class MessageController {
    ...
    public ResponseEntity<MessageDTO> createMessage(@PathVariable Long chatId, @PathVariable Long senderId, @RequestBody MessageDTO messageDTO) {
    ...
    public ResponseEntity<MessageDTO> getMessageByChatId(@PathVariable Long roomId, @RequestParam int page, @RequestParam int size) {
